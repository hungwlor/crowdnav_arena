...
class nav2py_crowdnav_attngraph_controller(nav2py.interfaces.nav2py_costmap_controller):
    ...
    def _data_callback(self, data):
        ...
        try:
            ...
            orient = robot_pose.get('orientation', {})
            x,y,z,w = orient.get('x', 0.0), orient.get('y', 0.0), orient.get('z', 0.0), orient.get('w', 0.0)
            rotate_z = 2 * (w * z + x * y) / (1 - 2 * (y * y + z * z))
            ...
            # demo_linear_x = 0.5  # Always move forward a bit
            ...
            from .crowdnav_attngraph_controller import compute_commands
            demo_linear_x,demo_angular_z = compute_commands(x,y,linear_x,angular_z,goal_x,goal_y,rotate_z)
            # except Exception as e:
...
if __name__ == "__main__":
    nav2py.main(nav2py_crowdnav_attngraph_controller)