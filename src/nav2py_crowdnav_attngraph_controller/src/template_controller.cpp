 ...
 */
 ...
 #include "nav2py_crowdnav_attngraph_controller/template_controller.hpp"
   ...
   const std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
 {
   ...
   // Initialize nav2py
   std::string nav2py_script = ament_index_cpp::get_package_share_directory("nav2py_crowdnav_attngraph_controller") + "/../../lib/nav2py_crowdnav_attngraph_controller/nav2py_run" ;
   ...
   RCLCPP_INFO(
     logger_,
     "Configured controller: %s of type nav2py_crowdnav_attngraph_controller::TemplateController",
     plugin_name_.c_str());
 }
 ...
 PLUGINLIB_EXPORT_CLASS(nav2py_crowdnav_attngraph_controller::TemplateController, nav2_core::Controller)