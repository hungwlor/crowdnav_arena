...
MODEL_DIR = '/home/sora/colcon_ws/src/CrowdNav_Prediction_AttnGraph/crowdnav_base/trained_models/crowdnav_sim'
TEST_MODEL = '01200.pt'
...
def main():
    ...
    with torch.no_grad():
        value,action,_,eval_recurrent_hidden_states = actor_critic.act(observation,eval_recurrent_hidden_states,eval_masks,deterministic=True)
    print(action[0][0].numpy(),action[0][1].numpy())